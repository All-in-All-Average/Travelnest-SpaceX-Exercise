...
I have made a quick react web-app to complete the excercise, the requested functionality should be working and data should be getting pulled from the provided API.
